...
public class EjemploStringMetodos {
    ...
    public void cuerpoStringMetodos2(){
        ...
        System.out.println("trabalenguas.endWith(\"lenguas\")= "+trabalenguas.endsWith("lenguas"));
        System.out.println("    trabalenguas     ");
        System.out.println("    trabalenguas     ".trim());

    }

    public void cuerpoStringMetodos(){
        ...
        System.out.println("nombre.compareTo(\"Andres\")= " + nombre.compareTo("Andres"));//usa un orden lexicografico para hacer la comparacion
        System.out.println("nombre.compareTo(\"Aaron\")= " + nombre.compareTo("Aaron"));//usa un orden lexicografico para hacer la comparacion
